...
// 参考https://github.com/arsmn/fiber-casbin
...
// 此方法尝试查询当前用户sub,并根据预定义的casbin策略确定sub是否具有所需的权限
...
// 此方法尝试查找当前sub，并根据预定义的casbin策略确定sub是否具有所需的权限，此方法用根据http的path、method、
...
// 尝试找到当前sub，并根据预定义的策略确定sub是否拥有所需的角色
